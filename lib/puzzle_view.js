...
class PuzzleView {
  ...
  handleClick (e) {
    ...
    let rgb = context.getImageData(e.layerX, e.layerY, 1, 1).data;
    // let hex = this.rgbToHex(rgb);
    //
    // let color = '0x' + hex.slice(1,70);

    // let hex2 = this.scene.children[0].children[0].children[0].children[0].material.color;
